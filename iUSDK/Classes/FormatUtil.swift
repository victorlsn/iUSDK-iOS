...
public class FormatUtil {
     ...
     */
    static func getValidPhoneNumber(_ phoneNumber: String, _ userAreaCode: String) -> String {
     ...
     */
    static func stripNonNumericDigitsFromString(_ originalString: String) -> String {
